...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (opcion != 8) {
            ...
            System.out.println("===== SISTEMA DE TRANSPORTE TURISTICO =====");
    ...
    public static void agregarColectivo(Scanner sc, EmpresaTurismo empresa,
            String patente, String marca, int capacidadPasajeros, int anioFabricacion) {
        ...
        ColectivoTuristico colectivo = new ColectivoTuristico(
                patente,
                marca,
                capacidadPasajeros,
                anioFabricacion,
    ...
    public static void agregarVan(Scanner sc, EmpresaTurismo empresa,
            String patente, String marca, int capacidadPasajeros, int anioFabricacion) {
        ...
        VanEjecutiva van = new VanEjecutiva(
                patente,
                marca,
                capacidadPasajeros,
                anioFabricacion,
    ...
    public static void agregarLancha(Scanner sc, EmpresaTurismo empresa,
            String patente, String marca, int capacidadPasajeros, int anioFabricacion) {
        ...
        LanchaTuristica lancha = new LanchaTuristica(
                patente,
                marca,
                capacidadPasajeros,
                anioFabricacion,
    ...
    public static void mostrarCapacidad(Scanner sc, EmpresaTurismo empresa) {
        ...
        System.out.print("Ingrese capacidad minima: ");
